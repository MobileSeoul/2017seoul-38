package com.gmail.jskapplications.seoulpicture.main.image_list;
 ...
 */
public class ImageRecyclerFragment extends BaseFragment implements View.OnClickListener {
    ...
    private ImageRecyclerFragment.ImageAdapter mAdapter;
    ...
    public static ImageRecyclerFragment newInstance(String userId, int spanCnt) {
        Bundle args = new Bundle();
        args.putString(USER_ID, userId);
        args.putInt(SPAN_CNT, spanCnt);
        ImageRecyclerFragment fragment = new ImageRecyclerFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        */
        ...
        mAdapter = new ImageRecyclerFragment.ImageAdapter(posts);
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if(posts.size() == mTotalDataCnt) {
                                    ...
                                    mShowMoreBtn.setBackgroundColor(Color.LTGRAY);
                                } else {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for(int i=0; i<dataArray.length(); i++) {
                                ...
                                posts.add(post);
                                //mAdapter.notifyItemChanged(i+postsSize);
                                Log.d("TLQKFK", posts.size()-1+"");
                                // mAdapter.notifyItemInserted(posts.size()-1);
    ...
    public ImageRecyclerFragment.ImageAdapter getRecyclerAdapter() {
        return mAdapter;
    }
    ...
    private class ImageAdapter extends RecyclerView.Adapter<ImageRecyclerFragment.ImageHolder> {
        ...
        @Override
        public ImageRecyclerFragment.ImageHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            LayoutInflater layoutInflater = LayoutInflater.from(getActivity());
            View view = layoutInflater.inflate(R.layout.grid_item_post, parent, false);
            return new ImageRecyclerFragment.ImageHolder(view);
        }

        @Override
        public void onBindViewHolder(ImageRecyclerFragment.ImageHolder holder, int position) {
